              ...
              <tbody>
                ...
                while ($row_package = mysqli_fetch_assoc($result)) {
                  ...
                  if ($status == 0) {
                    ...
                    $st = 'The booking has been canceled by the user.';
                  } else {
                    $st = 'The booking has been canceled by the administrator.';
                  }
                  echo '<tr>
                                    <td>' . $bkid . '</td>
                                    <td>' . $name . '</td>
                  ...
                  if ($status == 0) {
                    ...
                    echo '<form action="partials/_bookManage.php" method="POST">
                                                        <button name="cancelbook" class="btn btn-sm btn-danger" style="margin-left:10%;">Cancel</button>
                    ...
                    echo '<form action="partials/_bookManage.php" method="POST">
                                                        <button disabled name="cancelbook" class="btn btn-sm btn-danger" style="margin-left:10%;">Cancel</button>
                                                        <input type="hidden" name="cid" value="' . $book_id . '">
                                                    </form>';
                  }
                  echo '</div>
          ...
          <div class="form-row">
            ...
            <div class="form-group col-md-6 my-0">
              ...
              <select name="seater" id="seater" class="custom-select browser-default" required>
                ...
                for ($i = 1; $i <= 5; $i++) {
                ?>
                  <option value="<?php echo $i; ?>" <?php if ($seater == $i) {
                                                      echo "selected";
                                                    } ?>><?php echo $i; ?></option>
                <?php
                } ?>
