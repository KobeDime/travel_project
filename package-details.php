...
<section class="inner-2"> <img src="images/details.jpg" alt="">
				...
				<div class="row">
					...
					<div class="col-md-6 col-md-pull-6">
						...
						<ul class="process">
							...
							<li><i class="fa fa-tags" aria-hidden="true"></i> <strong>Price</strong> : <span class="price_color">₱ <span class="price_size"><?php echo $tour_package['package_price']; ?></span> Per Person</span></li>
						</ul>
