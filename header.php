...
<head>
  ...
  <title>Kobe Voyage Nexus</title>
  <link rel="icon" href="images/favicon.png">
  <link rel="apple-touch-icon-precomposed" href="images/nexus.png">
  <!-- Bootstrap -->
...
<body>
  <header>
    ...
    <div class="slide_menu"><a href="#0" class="close"><i class="fa fa-times"></i></a>
      <ul class="side-menu-list"><br><br><br><br><br><br><br><br>
        <li><a href="index.php">Discover Our World</a></li><br>
        <li><a href="about-us.php">Meet the Travel Expert</a></li><br>
        <li><a href="gallery.php">Wanderlust Photo Album</a></li><br>
        <li><a href="contact-us.php">Get in Touch with Us</a></li><br>
      </ul>
    </div>
    <div class="container"><a href="index.php" class="brand"><img src="images/nexus.png" alt=""></a>
      <div class="nav-right">
        <ul class="social">
          <li><a href="mailto:kobe24.dime@gmail.com"><i class="fa fa-envelope-o" aria-hidden="true"></i>kobe24.dime@gmail.com</a></li>
          <li class="border_r"></li>
          <li><a href="https://www.facebook.com/ohitskobe"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
          <li><a href="https://github.com/KobeDime"><i class="fa fa-github" aria-hidden="true"></i></a></li>
          <li><a href="https://x.com/kobeatom_"><i class="fa fa-twitter" aria-hidden="true"></i></a></li>
        </ul>
