...
<section class="inner-2"> 
    <img src="images/package.jpg" alt="packagePic">
        ...
        <div style="background:#999; padding:15px; display:flow-root">
            ...
            if (mysqli_num_rows($result_package) > 0) {
                while ($row_package = mysqli_fetch_assoc($result_package)) {
                    // Format the price
                    $formatted_price = number_format($row_package['package_price'], 0, '.', ',');
            ?>
                    <div class="col-md-3">
                        <div class="card">
                            <div class="card_img"> 
                                <img src="images/<?php echo $row_package['package_image']; ?>" alt=""> 
                            </div>
                            <div class="card_data">
                                ...
                                <?php if ($loggedin) {
                                    ...
                                    <div class="btn-flex"> 
                                        <a style="cursor:pointer;" data-toggle="modal" data-target="#loginModal" class="btn-detail">View Details</a>
                                    </div>
                                <?php } ?>
                            </div>
                        </div>
